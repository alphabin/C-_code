...
{
    cout<<"nPerimeter is :"<<IN.Lperi<<endl; //Access the necessary Lpreri from rectangle
}
void printArea(rectangle IN)
{
    cout<<"nArea is :" <<IN.Larea<<endl; //Access the necessary area
}
...
{
    cout<<"nPerimeter is :"<<IN.Lperi<<endl; //Acess the class private member Lperi
}
void printArea(triangle IN)
{
    cout<<"nArea is :" <<IN.Larea<<endl; //Acess the class private member Larea
}
int main()
{
    ...
    cout << "\nnRunning Rectangle Test Cases :: " << endl; // prints Test Case
    printArea(test);
    printPerimeter(test);
    cout << "\nEnds Tringle Test Cases :: " << endl; // prints Test Case
    return 0;
